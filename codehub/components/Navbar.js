...
>
  ...
  >
    <h1 className={styles.codeHUBLOGO}>CodeHUB</h1>
    <ul className="space-y-2 font-medium">
      <li>
        ...
        >
          ...
          <span className="ml-3"> <span >Dashboard</span></span>
        </a>
      </li>
      <li>
        <a
